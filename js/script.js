const global = {
    ...
    api: {
        apiKey: '1675b84e198cd2203f0e810b1d592a53',
    ...
    div.innerHTML = `
        <div class="details-top">
          ...
          <div>
            ...
            <h2>Show Info</h2>
            <ul>
            <li><span class="text-secondary">Number of Episodes:</span> ${show.number_of_espisodes}</li>
            <li><span class="text-secondary">Last Episode Air:</span> ${show.last_episode_to_air}</li>
